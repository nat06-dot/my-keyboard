...
public:
  ...
  /**
   * @brief DEBUG: Lists every namespace/key found in the "nvs" partition,
   * regardless of namespace name. Used to find where NimBLE actually
   * stores its bond data.
   */
  static void debugListAllEntries();
};
